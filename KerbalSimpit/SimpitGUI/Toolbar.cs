...
namespace KerbalSimpit.SimpitGUI
{
	...
	public class AppButton : MonoBehaviour
	{
		...
		public void Start()
		{
			iconRed = GameDatabase.Instance.GetTexture("KerbalSimpitRevamped/Simpit_icon_red", false);
			iconOrange = GameDatabase.Instance.GetTexture("KerbalSimpitRevamped/Simpit_icon_orange", false);
			iconGreen = GameDatabase.Instance.GetTexture("KerbalSimpitRevamped/Simpit_icon_green", false);
